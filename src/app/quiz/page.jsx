...
const QUESTIONS = [
  ...
  { id: 6,  prompt: 'How do you write a single-line comment?', options: ['// comment', '# comment', '<!-- comment -->', '/* comment */'], correctIndex: 1 },
  ...
  { id: 9,  prompt: 'Which structure is ordered and mutable?', options: ['tuple', 'list', 'set', 'dict'], correctIndex: 1 },
  { id: 10, prompt: 'Which literal is a tuple?', options: ['[1, 2, 3]', '{1, 2, 3}', '(1, 2, 3)', '{"a": 1}'], correctIndex: 2 },
  { id: 11, prompt: 'How do you add an item to the end of a list?', options: ['list.add(x)', 'list.push(x)', 'list.append(x)', 'list.extend(x)'], correctIndex: 2 },
  { id: 12, prompt: 'Which removes and returns the last list item?', options: ['remove()', 'pop()', 'delete()', 'discard()'], correctIndex: 1 },
  { id: 13, prompt: 'How do you access the first element of a list `nums`?', options: ['nums(0)', 'nums{0}', 'nums[0]', 'first(nums)'], correctIndex: 2 },
  { id: 14, prompt: 'Which literal creates a dictionary?', options: ['[1,2,3]', '{"a": 1, "b": 2}', '(1,2,3)', '{1,2,3}'], correctIndex: 1 },
  { id: 15, prompt: 'Safely get a value from dict `d` with default 0 for missing key "x":', options: ['d["x"] or 0', 'd.get("x", 0)', 'd.fetch("x", 0)', 'd.value("x", 0)'], correctIndex: 1 },
  { id: 16, prompt: 'Which checks if a key exists in a dictionary `d`?', options: ['"a" of d', 'contains(d, "a")', '"a" in d', 'd.has("a")'], correctIndex: 2 },
  { id: 17, prompt: 'Which makes a string uppercase?', options: ['toUpper()', 'upper()', 'uppercase()', 'capitalizeAll()'], correctIndex: 1 },
  { id: 18, prompt: 'Which removes leading and trailing whitespace from a string `s`?', options: ['trim(s)', 's.strip()', 's.clean()', 's.chomp()'], correctIndex: 1 },
  { id: 19, prompt: 'Combine ["a","b","c"] into "a,b,c":', options: ['",".concat(list)', '",".join(["a","b","c"])', 'join([",","a","b","c"])', 'str(["a","b","c"])'], correctIndex: 1 },
  { id: 20, prompt: 'Which is a correct f-string?', options: ['f("Hello {name}")', 'f\'Hello {name}\'', 'f{Hello name}', 'fstring("Hello {name}")'], correctIndex: 1 },
  { id: 21, prompt: 'What is 10 % 3?', options: ['3', '1', '0', 'Error'], correctIndex: 1 },
  { id: 22, prompt: 'bool([]) evaluates to…', options: ['True', 'False', 'None', 'Error'], correctIndex: 1 },
  { id: 23, prompt: 'Which statement about tuples is TRUE?', options: ['Tuples are mutable', 'Tuples are unordered', 'Tuples are immutable', 'Tuples can only hold numbers'], correctIndex: 2 },
  { id: 24, prompt: 'Which value is a float?', options: ['3', '3.0', '"3.0"', 'int(3)'], correctIndex: 1 },
  { id: 25, prompt: 'Which may raise a KeyError if the key is missing?', options: ['d.get("k")', 'd["k"]', '"k" in d', 'd.keys()'], correctIndex: 1 },
];
